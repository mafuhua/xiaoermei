 ...
 */
public class SPUtil {
    private static String PreferenceName = "userinfo";
    ...
    public static <T> boolean saveObjectToShare(String key, T t) {
        return saveObjectToShare(MyApplication.context, PreferenceName, key, t);
    }
    ...
    public static <T> T getObjectFromShare(String key) {
        return getObjectFromShare(MyApplication.context, PreferenceName, key);
    }
    ...
    public static void saveString(String key, String value) {
        SharedPreferences sp = MyApplication.context.getSharedPreferences(PreferenceName,
